...
Simple:Press
Desc:
$LastChangedDate: 2014-11-27 08:40:54 -0800 (Thu, 27 Nov 2014) $
$Rev: 12110 $
*/
...
function sp_populate_query_vars() {
	...
	$spVars['postwidth'] = 0;
	if(sp_get_option('sfpostwrap')) {
		# Try and get from cookie if set
		if (isset($_COOKIE['post_width_'.$spDevice])) {
			$spVars['postwidth'] = ($_COOKIE['post_width_'.$spDevice] - 20);
		}
	}
