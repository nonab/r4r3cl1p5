...
function spa_download_language_file($item) {
	...
	if($item == 'corefront' || $item == 'coreadmin') {
		...
		$home = WP_CONTENT_DIR.'/'.$spPaths['language-sp'].'/'.$homeName.'-'.$locale.'.mo';
	}
	...
	if($item == 'theme') {
		...
		$home = WP_CONTENT_DIR.'/'.$spPaths['language-sp-themes'].'/'.$homeName.'-'.$locale.'.mo';
	}
	...
	if($item == 'plugin') {
		...
		$home = WP_CONTENT_DIR.'/'.$spPaths['language-sp-plugins'].'/'.$homeName.'-'.$locale.'.mo';
	}
