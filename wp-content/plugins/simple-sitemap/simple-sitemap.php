				...
				<?php
					...
					if ( have_posts() ) :
						...
						while ( have_posts() ) :
							...
							<li class="post_item">
								<?php if (!strpos(get_the_content(),'mega.co.nz')) : ?>
								<a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php the_title(); ?> <span style="color:red">[DEAD]</span></a>
								<?php endif; ?>
