...
#	Author		:	Simple:Press
#
#	This is the main CSS file for the SP iForum theme.
...
#spMainContainer .spForumTopicSection a.spToolsButton {
	margin: 45px 0 0 5px;
}
