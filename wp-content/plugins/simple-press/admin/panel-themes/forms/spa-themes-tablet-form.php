...
<?php
            if (!empty($tabletTheme['parent'])) {
                if (file_exists(SPTHEMEBASEDIR.$tabletTheme['parent'])) {
                    ...
                    echo spa_text('This theme is a child theme of ').'<b>'.$tabletTheme['parent'].'</b>';
                    echo '</p>';
                } else {
                    echo '<p class="theme-parent">';
                    echo '<b>'.spa_text('The specified parent theme')." '".$tabletTheme['parent']."' ".spa_text('does not exist').'</b> ';
                    echo '</p>';
                }
            }
?>
...
<?php
            ...
            if (!empty($tabletTheme['parent'])) {
                $parent_overlays = sp_get_overlays(SPTHEMEBASEDIR.$tabletTheme['parent'].'/styles/overlays');
...
<?php
    	$numThemes = count($themes);
     	if ($numThemes > 1) {
?>
    		<table id="availablethemes" style="padding:0;border-spacing:0;border-collapse:separate;">
