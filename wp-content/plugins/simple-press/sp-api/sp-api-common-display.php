...
function sp_attach_user_profile_link($userid, $targetitem) {
	...
	switch ($sfprofile['displaymode']) {
		case 1:
			...
			$position = 'center';
			return "<a rel='nofollow' href='javascript:void(null)' class='spLink spProfilePopupLink' title='$title' onclick='spjDialogAjax(this, \"$site\", \"$title\", 750, 0, \"$position\");'>$targetitem</a>";
