...
Simple:Press
List Post Class
$LastChangedDate: 2014-12-18 20:31:37 -0800 (Thu, 18 Dec 2014) $
$Rev: 12185 $
*/
...
class spPostList {
	...
	function __construct($where='', $order='', $count=0, $view='forum-title', $type='') {
		$this->listData = $this->sp_postlistview_query($where, $order, $count, $view, $type);
