...
$LastChangedDate: 2014-06-06 07:52:41 -0700 (Fri, 06 Jun 2014) $
$Rev: 11522 $
*/
...
if (sp_has_groups()) : while (sp_loop_groups()) : sp_the_group();
	...
	$icon = (!empty($spThisGroup->group_icon)) ? SFCUSTOMURL.$spThisGroup->group_icon : sp_find_icon(SPTHEMEICONSURL, 'sp_GroupIcon.png');
