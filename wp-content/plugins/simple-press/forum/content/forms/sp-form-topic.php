...
$LastChangedDate: 2014-06-23 20:38:18 -0700 (Mon, 23 Jun 2014) $
$Rev: 11588 $
*/
...
function sp_render_add_topic_form($args) {
	...
	$out.= "<form class='$tagClass' action='".SFHOMEURL."index.php?sp_ahah=post&amp;sfnonce=".wp_create_nonce('forum-ahah')."' method='post' id='addtopic' name='addtopic' onsubmit='return spjValidatePostForm(this, $spThisUser->guest, 1, \"".sp_find_icon(SPTHEMEICONSURL, 'sp_Success.png')."\");'>\n";
