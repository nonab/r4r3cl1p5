...
Simple:Press
Topic View Class
$LastChangedDate: 2014-11-16 03:48:55 -0800 (Sun, 16 Nov 2014) $
$Rev: 12084 $
*/
...
class spTopicView {
	...
	function sp_topicview_query($topicid=0, $cPage=1, $forumid=0) {
		...
		$spdb = new spdbComplex;
			...
			$spdb->fields	= 'group_id, '.SFTOPICS.'.topic_id, '.SFTOPICS.'.forum_id, topic_name, topic_slug, topic_status, topic_pinned, topic_icon, topic_opened, '.SFTOPICS.'.post_count, forum_slug, forum_status,
		...
		if ($records) {
			...
			if (sp_get_auth('view_forum', $r->forum_id)) {
				...
				foreach ($records as $r) {
					...
					$t[$tidx]->posts[$pidx]->postUser			= sp_get_user($r->user_id, $cUser, $cSmall);
