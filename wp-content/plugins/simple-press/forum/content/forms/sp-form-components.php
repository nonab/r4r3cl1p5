	...
	foreach ($cOrder as $c) {
		switch($c) {
			...
			if ($spDevice == 'mobile' && array_key_exists('iconMobileSubmit', $a) && !empty($a['iconMobileSubmit'])) {
				# display mobile icon
				$out.= "<input type='image' src='".sp_find_icon(SPTHEMEICONSURL, "$iconMobileSubmit")."' class='spIcon' name='newtopic' id='sfsave' />";
			} else {
				# display default button
				$out.= "<input type='submit' $enabled tabindex='106' class='$controlSubmit' title='$tipSubmitButton' name='newtopic' id='sfsave' value='$buttontext' />\n";
			}
			break;
			...
			if ($spDevice == 'mobile' && array_key_exists('iconMobileCancel', $a) && !empty($a['iconMobileCancel'])) {
				# display mobile icon
				$out.= "<img src='".sp_find_icon(SPTHEMEICONSURL, "$iconMobileCancel")."' class='spIcon' name='cancel' id='sfcancel' onclick='if (confirm(\"".$msg."\")) {spjEdCancelEditor();}' />";
			} else {
				# display default button
				$out.= "<input type='button' tabindex='107' class='$controlSubmit' title='$tipCancelButton' id='sfcancel' name='cancel' value='$labelPostCancel' onclick='if (confirm(\"".$msg."\")) {spjEdCancelEditor();}' />\n";
			}
		}
	}
...
function sp_post_editor_submit_buttons($out, $spThisTopic, $a, $toolbar) {
	...
	foreach ($cOrder as $c) {
		switch($c) {
			...
			if ($spDevice == 'mobile' && array_key_exists('iconMobileSubmit', $a) && !empty($a['iconMobileSubmit'])) {
				# display mobile icon
				$out.= "<input type='image' src='".sp_find_icon(SPTHEMEICONSURL, "$iconMobileSubmit")."' class='spIcon' name='newpost' id='sfsave' />";
			} else {
				# display default button
				$out.= "<input type='submit' $enabled tabindex='106' class='$controlSubmit' title='$tipSubmitButton' name='newpost' id='sfsave' value='$buttontext' />\n";
			}
			break;
...
function sp_post_editor_edit_submit_buttons($out, $spThisTopic, $a, $toolbar) {
	...
	foreach ($cOrder as $c) {
		switch($c) {
			...
			if ($spDevice == 'mobile' && array_key_exists('iconMobileSubmit', $a) && !empty($a['iconMobileSubmit'])) {
				# display mobile icon
				$out.= "<input type='image' src='".sp_find_icon(SPTHEMEICONSURL, "$iconMobileSubmit")."' class='spIcon' name='editpost' id='sfsave' />";
			} else {
				# display default button
			...
			if ($spDevice == 'mobile' && array_key_exists('iconMobileCancel', $a) && !empty($a['iconMobileCancel'])) {
				# display mobile icon
				$out.= "<input type='image' src='".sp_find_icon(SPTHEMEICONSURL, "$iconMobileCancel")."' class='spIcon' name='cancel' id='sfcancel' onclick='if (confirm(\"".$msg."\")) {document.editpostform.submit();}' />";
			} else {
				# display default button
				$out.= "<input type='button' tabindex='107' class='$controlSubmit' title='$tipCancelButton' id='sfcancel' name='cancel' value='$labelPostCancel' onclick='if (confirm(\"".$msg."\")) {document.editpostform.submit();}' />\n";
			}
		}
	}
