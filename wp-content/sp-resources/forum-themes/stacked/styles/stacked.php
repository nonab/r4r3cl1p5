...
#	Author		:	Simple:Press
#
#	This is the main CSS file for the SP Stacked theme.
...
#spMainContainer .spTopicPostSection .spAvatarSection {
	padding-top: 5px;
	padding-left: 5px;
	padding-right: 10px;
}

#spMainContainer .spTopicPostSection .spInfoSection {
	padding-left: 25px;
}
