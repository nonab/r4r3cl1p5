...
$LastChangedDate: 2014-11-11 02:01:39 -0800 (Tue, 11 Nov 2014) $
$Rev: 12066 $
*/
...
function sp_GroupOpenClose($args='', $toolTipOpen='', $toolTipClose='') {
	...
	$out = "<span id='$tagId' onclick='spjOpenCloseForums(\"$div\", \"$tagId\", \"$tagClass\", \"$openIcon\", \"$closeIcon\", \"$toolTipOpen\", \"$toolTipClose\");'><img class='$tagClass' title='$tooltip' src='$icon' alt='' /></span>\n";
...
function sp_ForumIndexStatusIcons($args='', $toolTipLock='', $toolTipPost='', $toolTipAdd='', $toolTipDenied='') {
	...
	if ($showDenied && !$spThisForum->start_topics && !empty($toolTipDenied)) {
		...
		$out.= "<img class='' src='$icon' title='$toolTipDenied' alt='' />\n";
	}
